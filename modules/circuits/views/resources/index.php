...
<div>
    <a id="request-container-btn" class="btn btn-primary">Instanciar novo container</a>
    <a id="dget-containers-btn" class="btn btn-default">Verificar containers ativos</a>
</div><br>
