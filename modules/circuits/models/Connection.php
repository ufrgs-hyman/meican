...
class Connection extends \yii\db\ActiveRecord
{
    ...
    const STATUS_WAITING_DATAPLANE = "WAITING_DATAPLANE";
    ...
    public function buildEvent($eventType, $message = null) {
        ...
        $event->status = ConnectionEvent::STATUS_INPROGRESS;
        return $event;
    }
    ...
    public function confirmRelease() {
        ...
        //nao valido para dummyrequester
    ...
    public function getStatus() {
        switch($this->status) {
            ...
            case self::STATUS_RELEASED:         return Yii::t("circuits", "Released resources");
            case self::STATUS_RELEASING:        return Yii::t("circuits", "Releasing resources");
        }
    }
