...
return array(
        ...
        'You are not allowed to access authorizations' => 'Você não tem permissão para acessar autorizações',
        'You are not allowed to answer authorizations' => 'Você não tem permissão para responder autorizações',
