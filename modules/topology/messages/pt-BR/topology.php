...
return array( 
		...
		'You are not allowed to add locations' => 'Você não tem permissão para adicionar localizações',
		...
		'Topology Viewer options' => 'Opções de Visualização da Topologia',
		'Port Location' => 'Localização da Porta',
		'Port' => 'Porta',
		'Capacity' => 'Capacidade',
		'Capacity (Mbps)' => 'Capacidade (Mbps)',
		'Reservable Capacity' => 'Capacidade Reservável',
		'Max Reservable Capacity (Mbps)' => 'Capacidade Max Reservável (Mbps)',
		'Min Reservable Capacity (Mbps)' => 'Capacidade Min Reservável (Mbps)',
		...
		'Location {name} added successfully' => 'Localização {name} adicionada com sucesso',
		'Location {name} deleted' => 'Dispositivo {name} removido',
