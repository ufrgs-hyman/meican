...
class Service extends \yii\db\ActiveRecord
{
    ...
    const TYPE_NMWG_TD_3_0 = 'NMWG_TD_3_0';
    ...
    public function getType() {
        switch ($this->type) {
            ...
            case self::TYPE_NMWG_TD_3_0: return self::getTypeLabels()[self::TYPE_NMWG_TD_3_0];
    ...
    static function getTypeLabels() {
        return [
            ...
            self::TYPE_NMWG_TD_3_0 => Yii::t('topology', 'NMWG Topology Description 3.0'),
    ...
    static function getTypes() {
        return [
            ...
            ['id'=> self::TYPE_NMWG_TD_3_0, 'name'=> self::getTypeLabels()[self::TYPE_NMWG_TD_3_0]],
