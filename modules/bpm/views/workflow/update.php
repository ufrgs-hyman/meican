...
use meican\bpm\assets\UpdateAsset;
...
<div class="box box-default">
    ...
    <div  id="frame" class="box-body">  
		<iframe class="embed-responsive-item" style="width: 100%; height: 640px; border: none;" name="workflow_editor" id="workflow_editor" src="<?php echo Yii::$app->urlManager->createUrl(['bpm/workflow/editor-update', 'id' => $_GET['id'], 'lang' => Yii::$app->language]);?>"></iframe>
	</div>
