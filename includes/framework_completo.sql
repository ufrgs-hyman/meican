...
--
-- Host: localhost
-- Generation Time: May 26, 2011 at 08:03 PM
...
(1, 1, 'group_info', 1, 150, NULL),
(2, 1, 'user_info', 2, 3, 1),
(3, 2, 'group_info', 4, 141, 1),
(4, 3, 'group_info', 142, 145, 1),
(5, 4, 'group_info', 146, 149, 1),
(6, 5, 'group_info', 5, 32, 3),
(7, 6, 'group_info', 6, 9, 6),
(8, 7, 'group_info', 10, 21, 6),
(9, 8, 'group_info', 33, 56, 3),
(10, 9, 'group_info', 34, 37, 9),
(11, 10, 'group_info', 38, 41, 9),
(12, 11, 'group_info', 57, 100, 3),
(13, 12, 'group_info', 58, 61, 12),
(14, 13, 'group_info', 62, 65, 12),
(15, 14, 'group_info', 101, 120, 3),
(16, 15, 'group_info', 102, 105, 15),
(17, 16, 'group_info', 106, 109, 15),
(18, 17, 'group_info', 121, 140, 3),
(19, 18, 'group_info', 122, 125, 18),
(20, 19, 'group_info', 126, 129, 18),
(21, 2, 'user_info', 143, 144, 4),
(22, 3, 'user_info', 147, 148, 5),
(23, 4, 'user_info', 7, 8, 7),
(24, 5, 'user_info', 11, 20, 8),
(25, 6, 'user_info', 35, 36, 10),
(26, 7, 'user_info', 39, 40, 11),
(27, 8, 'user_info', 59, 60, 13),
(28, 9, 'user_info', 63, 64, 14),
(29, 10, 'user_info', 103, 104, 16),
(30, 11, 'user_info', 107, 108, 17),
(31, 12, 'user_info', 123, 124, 19),
(32, 13, 'user_info', 127, 128, 20),
(33, 1, 'network_info', 22, 31, 6),
(34, 2, 'network_info', 42, 55, 9),
(35, 3, 'network_info', 66, 99, 12),
(36, 4, 'network_info', 110, 119, 15),
(37, 5, 'network_info', 130, 139, 18),
(38, 1, 'device_info', 23, 26, 33),
(39, 2, 'device_info', 27, 30, 33),
(40, 3, 'device_info', 43, 48, 34),
(41, 4, 'device_info', 49, 54, 34),
(42, 5, 'device_info', 67, 82, 35),
(43, 6, 'device_info', 83, 98, 35),
(44, 7, 'device_info', 111, 114, 36),
(45, 8, 'device_info', 115, 118, 36),
(46, 9, 'device_info', 131, 134, 37),
(47, 10, 'device_info', 135, 138, 37),
(48, 1, 'urn_info', 44, 45, 40),
(49, 2, 'urn_info', 46, 47, 40),
(50, 3, 'urn_info', 50, 51, 41),
(51, 4, 'urn_info', 52, 53, 41),
(52, 5, 'urn_info', 68, 69, 42),
(53, 6, 'urn_info', 70, 71, 42),
(54, 7, 'urn_info', 72, 73, 42),
(55, 8, 'urn_info', 74, 75, 42),
(56, 9, 'urn_info', 76, 77, 42),
(57, 10, 'urn_info', 78, 79, 42),
(58, 11, 'urn_info', 80, 81, 42),
(59, 12, 'urn_info', 84, 85, 43),
(60, 13, 'urn_info', 86, 87, 43),
(61, 14, 'urn_info', 88, 89, 43),
(62, 15, 'urn_info', 90, 91, 43),
(63, 16, 'urn_info', 92, 93, 43),
(64, 17, 'urn_info', 94, 95, 43),
(65, 18, 'urn_info', 96, 97, 43),
(66, 19, 'urn_info', 24, 25, 38),
(67, 20, 'urn_info', 28, 29, 39),
(68, 21, 'urn_info', 112, 113, 44),
(69, 22, 'urn_info', 116, 117, 45),
(70, 23, 'urn_info', 132, 133, 46),
(71, 24, 'urn_info', 136, 137, 47),
(72, 1, 'flow_info', 12, 13, 24),
(73, 1, 'timer_info', 14, 15, 24),
(74, 1, 'reservation_info', 16, 17, 24),
(75, 1, 'request_info', 18, 19, 24);
...
(17, 8, 6, 'urn_info', 'deny', 'allow', 'deny', 'deny'),
(18, 5, 1, 'reservation_info', 'allow', 'allow', 'allow', 'allow');
...
CREATE TABLE IF NOT EXISTS `domain_info` (
  ...
  `dom_descr` varchar(16) DEFAULT NULL,
  `dom_ip` varchar(64) NOT NULL,
  `topo_ip` varchar(32) DEFAULT NULL,
  `ode_ip` varchar(32) DEFAULT NULL,
  PRIMARY KEY (`dom_ip`),
...
INSERT INTO `domain_info` (`dom_id`, `dom_descr`, `dom_ip`, `topo_ip`, `ode_ip`) VALUES
(5, 'Ipe Dom', '200.132.1.28', NULL, '200.132.1.28:8080'),
(1, 'Pietro Dom', 'noc.inf.ufrgs.br:65501', NULL, 'noc.inf.ufrgs.br:65401'),
(2, 'Juliano Dom', 'noc.inf.ufrgs.br:65502', NULL, 'noc.inf.ufrgs.br:65402'),
(3, 'Jair Dom', 'noc.inf.ufrgs.br:65503', NULL, 'noc.inf.ufrgs.br:65403'),
(4, 'Felipe Dom', 'noc.inf.ufrgs.br:65504', NULL, 'noc.inf.ufrgs.br:65404'),
(6, 'Leonardo Dom', 'noc.inf.ufrgs.br:65506', NULL, 'noc.inf.ufrgs.br:65406');
...
(1, 'Fluxo UFRGS-UNIFACS', 100, 1, 'urn:ogf:network:domain=ufsc.cipo.rnp.br:node=UFRGS-CIPO-RNP-001:port=5:link=*', 0, 1, 'urn:ogf:network:domain=ufsc.cipo.rnp.br:node=UNIFACS-CIPO-RNP-001:port=5:link=*', 0);
...
INSERT INTO `request_info` (`loc_id`, `req_id`, `dom_src`, `usr_src`, `dom_dst`, `resource_type`, `resource_id`, `answerable`, `status`, `response`, `message`) VALUES
(1, 1, 1, 5, 1, 'reservation_info', 1, 'yes', 'SENT FOR AUTHORIZATION', '', '');
...
(1, 'Dia 26 de maio + 2 dias', '2011-05-26 20:00:00', '2011-05-26 21:30:00', 'DAILY', '0000-00-00 00:00:00', 2, 1, '', 'Repetir a cada dia, 2 vezes');
