 ...
 */
	public static function config($key, $config) {
		...
		if (!$logger instanceof LogInterface) {
			throw new LogException(sprintf('logger class %s does not implement a write method.', $loggerName
			));
		}
 ...
 */
	protected static function _getLogger($loggerName) {
        ...
        include_once 'libs/Log/Engine/'.$loggerName.'.php';
		if (!class_exists($loggerName)) {
			throw new LogException(sprintf('Could not load class %s', $loggerName));
		}
		return $loggerName;
	}
