	...
	modules: [
{
...

	{
					...
					{"type": "inplaceedit", "inputParams": {
						"name": "post",
						"editorField":{"type": "select", "inputParams": {"label": "", "name": "title", "selectValues": ["RNP","UFRGS","UFPA"]}},
				...
				},
				{
					...
					{"type": "inplaceedit", "inputParams": {
						"name": "post",
						"editorField":{"type": "select", "inputParams": 
							{"label": "", "name": "title", "selectValues": ["Fulano","Ciclano","Beltrano"]} },
						"animColors":{"from":"#FFFF99" , "to":"#DDDDFF"}
					}}, 
			...
			"inputParams": {
				...
				editorField: {
					...
					inputParams: {fields:[
						...
						{"type": "select", "inputParams": { "name": "operator", "selectValues": ["==","<","<=",">",">="] } },
	   					{"inputParams": {"name": "bandwidth", "required": true }}
					]}
				},
	      ...
	      },
	       {
			...
			"fields": [
					{"type": "inplaceedit", "inputParams": {
						"name": "post",
						"editorField":{"type": "select", "inputParams": 
							{"label": "", "name": "title", "selectValues": ["Admin","Engenheiros","Comum"]} },
						"animColors":{"from":"#FFFF99" , "to":"#DDDDFF"}
					}}, 
