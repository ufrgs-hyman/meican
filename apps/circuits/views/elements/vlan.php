<table>
    ...
    <tr>
        ...
        <td>
            <input type="text" id="src_vlanText" disabled="disabled" onkeyup="changeTagValue('src');"/>
            <div id="src_vlanTip"/>
        </td>
        <td>
            <input type="text" id="dst_vlanText" disabled="disabled" onkeyup="changeTagValue('dst');"/>
            <div id="dst_vlanTip"/>
        </td>
    </tr>
</table>