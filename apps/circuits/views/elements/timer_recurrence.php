                            ...
                            <table cellspacing="0" cellpadding="0" style="width: 100%" class="withoutBorder">
                                <tr>
                                    ...
                                    <td class="recurrence_table" style="text-align: left">
                                        ...
                                        <?php echo _("On"); ?>
                                        <input type="text" name="until_date" size="9" readonly disabled class="datePicker" id="untilDate" value="<?php if ($timer && $timer->until) echo $timer->until; else echo $finish_date; ?>" onchange="setUntilType()"></label>
                                    </td>
                                </tr>
                            </table>
                        </td>
