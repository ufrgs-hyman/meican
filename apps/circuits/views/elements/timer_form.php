...
<link type="text/css" rel="stylesheet" href="apps/circuits/data/ui-lightness/jquery-ui-1.8.11.custom.css?1" media="screen">
...
<table>
    ...
    <tr>
        <td>
            <input type="text" size="9" value="<?php echo $start_date; ?>" readonly class="datePicker" id="initialDate">
        </td>
        <td>
            <input type="text" size="7" value="<?php echo $start_time; ?>" class="hourPicker" id="initialTime">
        </td>
        <td>
            <?php echo _("until"); ?>
        </td>
        <td>
            <input type="text" size="9" value="<?php echo $finish_date; ?>" readonly class="datePicker" id="finalDate">
        </td>
        <td>
            <input type="text" size="7" value="<?php echo $finish_time; ?>" class="hourPicker" id="finalTime">
        </td>
    </tr>
