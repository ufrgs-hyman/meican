...
<form>
    <div id="edp-dialog-form" title="<?= _("Search host endpoint"); ?>">
        <label for="edp_reference"><?= _("Fill in with a hostname, IP address or URN") ?></label>
        <br/>
        <input type="text" name="edp_reference" id="edp_reference" size="50" style="margin-top: 10px;" placeholder="<?php echo _('Enter text') ?>" title="<?= _('Hostname, IP address or URN'); ?>"/>
        <input type="hidden" id="edp-dialog"/>
    </div>
</form>

<div id="copy-edp-dialog" title="<?= _("Copy endpoint link"); ?>">
