...
<table class="withoutBorder" style="width: 100%">
    <tr>
        <td style="width: 48%; vertical-align: top">
            <div id="res_mapCanvas" class="tab_subcontent" style="border: solid #BBB 1px; box-shadow: 2px 2px 4px #888; border-image: initial;width:100%; height:365px;"></div>       
        </td>
        <td style="width: 48%; padding-left: 15px; vertical-align: top">
            <table style="min-width: 30%" class="withoutBorder">
                ...
                <tr>
                    ...
                    <th style="border-bottom:none; padding-left: 5px; text-align: left"><?php echo $usr_login; ?></th>
                </tr>
            </table>
...
<?php if ($request)
    $this->addElement('view_request', $request); ?>
