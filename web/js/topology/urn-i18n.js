...
dict['pt-BR']['The selected URNs will be deleted.<br>Do you confirm?'] = 'As URLs selecionadas serão removidas.<br>Você deseja continuar?';
dict['pt-BR']['Yes'] = 'Sim';
dict['pt-BR']['No'] = 'Não';
dict['pt-BR']['Delete this URN?'] = 'Remover esta URN?';
dict['pt-BR']['Confirm'] = 'Confirmar';
dict['pt-BR']['Cancel'] = 'Cancelar';
dict['pt-BR']['Save URN failed, please check the camps'] = 'Falhou ao salvar a URN. Por favor, cheque os campos';
dict['pt-BR']['Update this URN?'] = 'Atualizar esta URN?';
dict['pt-BR']['Save this URN?'] = 'Salvar esta URN?';
...
dict['pt-BR']['Please insert a port'] = 'Por favor, insira uma porta';
dict['pt-BR']['Please insert a description'] = 'Por favor, insira uma descrição';
